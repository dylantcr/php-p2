...
<body>
    <div class="navbar">
        ...
        <a href="#producten">Trending</a>
        <a href="#producten">New Release</a>
        <a href="#over-ons">Over Ons</a>
        <a href="#contact">Contact</a>
        <a href="#login" style="float: right;">Inloggen</a> <!-- Login-knop rechts uitgelijnd -->
    </div>
    ...
    <div class="products-container">
        ...
        if ($stmt->rowCount() > 0) {
            ...
            while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<img src='" . $row["foto"] . "' alt='" . $row["naam"] . "'>";
                echo "<h3>" . $row["merk"] . "</h3>";
                echo "<h3>" . $row["naam"] . "</h3>";
